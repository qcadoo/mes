...
public interface SimpleMaterialBalanceConstants {
    ...
    public static final String PLUGIN_IDENTIFIER = "simpleMaterialBalance";

    // MODEL
    public static final String MODEL_SIMPLE_MATERIAL_BALANCE = "simpleMaterialBalance";
    ...
    public static final String VIEW_SIMPLE_MATERIA_BALANCE_DETAILS = "simpleMaterialBalanceDetails";
