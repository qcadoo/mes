...
public final class SimpleMaterialBalancePdfService extends PdfDocumentService {
    ...
    private void addBalance(final Document document, final Entity simpleMaterialBalance, final Locale locale)
        ...
        for (Entry<Entity, BigDecimal> entry : products.entrySet()) {
            ...
            table.addCell(new Phrase(numberService.getDecimalFormat().format(entry.getValue()), PdfUtil.getArialRegular9Dark()));
            ...
            table.addCell(new Phrase(numberService.getDecimalFormat().format(available), PdfUtil.getArialRegular9Dark()));
            table.addCell(new Phrase(numberService.getDecimalFormat().format(
