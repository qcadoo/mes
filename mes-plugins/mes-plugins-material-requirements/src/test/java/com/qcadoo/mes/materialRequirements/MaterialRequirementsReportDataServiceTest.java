...
public class MaterialRequirementsReportDataServiceTest {

    private MaterialRequirementsReportDataService materialRequirementsReportDataService = null;
    ...
    @Before
    public void init() {
        materialRequirementsReportDataService = new MaterialRequirementsReportDataService();
