        ...
        if (!productWithCosts.isEmpty()) {
            for (Entry<Entity, BigDecimal> productWithCost : productWithCosts.entrySet()) {
                ...
                if (balanceOperationProductInComponent != null) {
                    ...
                    technologyInstanceOperationProductInComponent.setField(L_PLANNED_COST, numberService.setScale(productCost));
                    technologyInstanceOperationProductInComponent.setField(L_REGISTERED_COST,
                            numberService.setScale(productRegisteredCost));
                    technologyInstanceOperationProductInComponent.setField(L_BALANCE, numberService.setScale(balance));
