...
@Aspect
@Service
public final class BatchStateChangeAspect extends AbstractStateChangeAspect {

    public static final String SELECTOR_POINTCUT = "this(com.qcadoo.mes.advancedGenealogy.states.aop.BatchStateChangeAspect)";
    ...
    public StateChangeEntityDescriber getChangeEntityDescriber() {
        return batchStateChangeDescriber;
    }
    ...
    protected int getNumOfPhases() {
        return BatchStateChangePhase.getNumOfPhases();
    }
