...
public class ParametersListenersAGFO {
    ...
    public void redirectToAdvancedGenealogyParameters(final ViewDefinitionState view,
            final ComponentState componentState, final String[] args) {
        Long parameterId = (Long) componentState.getFieldValue();

        if (parameterId != null) {
            String url = "../page/advancedGenealogy/advancedGenealogyParameters.html?context={\"form.id\":\"" + parameterId
                    + "\"}";
