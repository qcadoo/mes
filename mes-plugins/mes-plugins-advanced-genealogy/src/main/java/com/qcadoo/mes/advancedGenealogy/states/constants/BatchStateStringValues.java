...
public final class BatchStateStringValues {

    private BatchStateStringValues() {

    }

    public static final String WILDCARD_STATE = RunForStateTransitionAspect.WILDCARD_STATE;

    public static final String TRACKED = "01tracked";

    public static final String BLOCKED = "02blocked";
}
