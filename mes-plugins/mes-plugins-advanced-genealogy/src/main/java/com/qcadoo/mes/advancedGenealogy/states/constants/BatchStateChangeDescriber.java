...
@Service
public final class BatchStateChangeDescriber extends AbstractStateChangeDescriber {
    ...
    public DataDefinition getDataDefinition() {
        return dataDefinitionService.get(AdvancedGenealogyConstants.PLUGIN_IDENTIFIER,
                AdvancedGenealogyConstants.MODEL_BATCH_STATE_CHANGE);
    }
    ...
    public String getOwnerFieldName() {
        return BatchStateChangeFields.BATCH;
    }

    @Override
    public StateEnum parseStateEnum(final String stringValue) {
        return BatchState.parseString(stringValue);
    }
