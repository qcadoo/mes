...
<script src="/advancedGenealogy/public/js/multiuploadfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/advancedGenealogy/multiUploadFiles.html" method="POST" enctype="multipart/form-data">
