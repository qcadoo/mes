...
@Service
public class MaterialRequirementCoverageForOrderColumnFetcher {
    ...
    private void fetchColumnValues(final Map<Entity, Map<String, String>> columnValues, final String methodName,
        ...
        List<Entity> columnsForOrderCoverages = materialRequirementCoverageForOrderService.getColumnsForCoveragesForOrder();

        Set<String> classNames = new HashSet<String>();

        for (Entity columnForCoverages : columnsForOrderCoverages) {
            String className = columnForCoverages.getStringField(ColumnForCoveragesForOrderFields.COLUMN_FILLER);
