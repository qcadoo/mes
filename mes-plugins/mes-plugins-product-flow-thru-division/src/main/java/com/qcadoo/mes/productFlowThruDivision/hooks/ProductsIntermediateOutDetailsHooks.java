...
@Service
public class ProductsIntermediateOutDetailsHooks {
    ...
    public void onBeforeRender(final ViewDefinitionState view) {
        ...
        productsFlowLocationLookup.setEnabled(ProductionFlowComponent.WAREHOUSE.getStringValue().equals(
                opoc.getField(TechnologyFieldsPFTD.PRODUCTION_FLOW)));
        String typeOfProductionRecording = opoc.getBelongsToField(OperationProductOutComponentFields.OPERATION_COMPONENT)
