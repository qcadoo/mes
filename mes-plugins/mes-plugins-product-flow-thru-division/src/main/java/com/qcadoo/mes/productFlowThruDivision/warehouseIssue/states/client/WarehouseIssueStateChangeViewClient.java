 ...
 * ***************************************************************************
 */
package com.qcadoo.mes.productFlowThruDivision.warehouseIssue.states.client;
...
@Service
public class WarehouseIssueStateChangeViewClient extends AbstractStateChangeViewClient {
    ...
    protected StateChangeService getStateChangeService() {
        return warehouseIssueStateChangeAspect;
    }
