...
@Service
public class WarehouseIssueListListeners {

    @Autowired
    private WarehouseIssueGenerator warehouseIssueGenerator;

    public void generateWarehouseIssues(final ViewDefinitionState view, final ComponentState state, final String[] args) {
        warehouseIssueGenerator.generateWarehouseIssuesTrigger();
    }
}
