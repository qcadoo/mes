...
<script src="/technologies/public/js/technologiesmultiuploadfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/technologies/technologiesMultiUploadFiles.html" method="POST" enctype="multipart/form-data">
