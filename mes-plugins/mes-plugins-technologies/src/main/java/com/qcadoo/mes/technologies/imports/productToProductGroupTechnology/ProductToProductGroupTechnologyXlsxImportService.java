...
public class ProductToProductGroupTechnologyXlsxImportService extends XlsxImportService {
    ...
    public void validateEntity(final Entity entity, final DataDefinition dataDefinition) {
        if (!ProductFamilyElementType.PRODUCTS_FAMILY.getStringValue().equals(
                entity.getBelongsToField(ProductToProductGroupFields.PRODUCT_FAMILY).getStringField(ProductFields.ENTITY_TYPE))) {
        ...
        if (!entity.getBelongsToField(ProductToProductGroupFields.PRODUCT_FAMILY).equals(
                entity.getBelongsToField(ProductToProductGroupFields.ORDER_PRODUCT).getBelongsToField(ProductFields.PARENT))) {
