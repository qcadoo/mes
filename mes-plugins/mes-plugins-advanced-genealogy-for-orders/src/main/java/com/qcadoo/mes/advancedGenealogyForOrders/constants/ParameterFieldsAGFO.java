...
public final class ParameterFieldsAGFO {

    private ParameterFieldsAGFO() {

    }

    public static final String TRACKING_RECORD_FOR_ORDER_TREATMENT = "trackingRecordForOrderTreatment";
