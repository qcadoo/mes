...
public class ProductsModifyControllerAddModifyEntity {
    ...
    public void shouldReturnAddConfirmationWhenRequiredDataIsGiven() {
        ...
        // when
        ModelAndView modelAndView = controller.saveEntity(entity);
        // then
        assertEquals("redirect:list.html?message=added", modelAndView.getViewName());
    ...
    public void shouldReturnEditConfirmationWhenRequiredDataIsGiven() {
        ...
        ModelAndView modelAndView = controller.saveEntity(entity);
        // then
        assertEquals("redirect:list.html?message=modified", modelAndView.getViewName());
