...
public class CrudController {
    ...
    public CrudController(DataDefinitionService dataDefinitionService, DataAccessService dataAccessService, Logger logger,
    ...
    public final ModelAndView getEntityListView(String viewName, String entityType, String message) {
    ...
    protected final ListData getEntitiesGridData(String entityType) {
        return getEntitiesGridData(entityType, null, null, null, null, null, null);
    }

    protected final ListData getEntitiesGridData(String entityType, Long parentEntityId, String entityParentField) {
        return getEntitiesGridData(entityType, parentEntityId, entityParentField, null, null, null, null);
    }

    protected final ListData getEntitiesGridData(String entityType, Integer maxResults, Integer firstResult, String sortColumn,
            String sortOrder) {
        return getEntitiesGridData(entityType, null, null, maxResults, firstResult, sortColumn, sortOrder);
    }

    protected final ListData getEntitiesGridData(String entityType, Long parentEntityId, String entityParentField,
            Integer maxResults, Integer firstResult, String sortColumn, String sortOrder) {
        ...
        return ListDataUtils.generateListData(rs, null);
    }

    protected final ModelAndView getEntityFormView(String viewName, Long entityId, String entityType, Long parentEntityId,
    ...
    protected final ValidationResult saveEntity(Entity entity, String entityType, Locale locale) {
        DataDefinition entityDataDefinition = dataDefinitionService.get(entityType);
    ...
    protected final String deleteEntity(List<Integer> selectedRows, String entityType) {
    ...
    private void insertDictionaryValues(ModelAndView mav, DataDefinition entityDataDefinition) {
        ...
        /*
         * for (FieldDefinition fieldDef : entityDataDefinition.getFields()) { switch (fieldDef.getType().getNumericType()) { case
         * FieldTypeFactory.NUMERIC_TYPE_BELONGS_TO: BelongsToFieldType belongsToField = (BelongsToFieldType) fieldDef.getType();
         * Map<Long, String> fieldOptions = belongsToField.lookup(null); dictionaryValues.put(fieldDef.getName(), fieldOptions);
         * break; case FieldTypeFactory.NUMERIC_TYPE_DICTIONARY: case FieldTypeFactory.NUMERIC_TYPE_ENUM: EnumeratedFieldType
         * enumeratedField = (EnumeratedFieldType) fieldDef.getType(); List<String> options = enumeratedField.values(); Map<Long,
         * String> fieldOptionsMap = new HashMap<Long, String>(); Long key = (long) 0; for (String option : options) {
         * fieldOptionsMap.put(key++, option); } dictionaryValues.put(fieldDef.getName(), fieldOptionsMap); break; } }
