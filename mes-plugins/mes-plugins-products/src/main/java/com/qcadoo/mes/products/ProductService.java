...
public final class ProductService {
    ...
    public void printMaterialRequirementForOrder(final ViewDefinitionState viewDefinitionState, final ComponentState state,
        ...
        if (state.getFieldValue() instanceof Long) {
            ...
            if (order == null) {
                ...
                ProductsWorkPlan workPlan = createNewWorkPlan(order);

                try {
                    generateWorkPlanDocuments(state, (Entity) workPlan);
                } catch (IOException e) {
    ...
    private ProductsWorkPlan createNewWorkPlan(Entity order) {
        ProductsWorkPlan workPlan = new ProductsWorkPlan();
        workPlan.setDate(new Date());
        workPlan.setFileName("autoGeneratedPlan");
        workPlan.setGenerated(true);
        workPlan.setName("autoGeneratedPlan");
        workPlan.setWorker(securityService.getCurrentUser().getUserName());
