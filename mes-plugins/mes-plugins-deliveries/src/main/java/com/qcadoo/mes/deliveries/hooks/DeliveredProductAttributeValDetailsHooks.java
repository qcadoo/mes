...
@Service
public class DeliveredProductAttributeValDetailsHooks {
    ...
    public void onBeforeRender(final ViewDefinitionState view) {
        ...
        LookupComponent attributeValueLookup = (LookupComponent) view
                .getComponentByReference(DeliveredProductAttributeValFields.ATTRIBUTE_VALUE);
        FieldComponent valueField = (FieldComponent) view.getComponentByReference(DeliveredProductAttributeValFields.VALUE);
