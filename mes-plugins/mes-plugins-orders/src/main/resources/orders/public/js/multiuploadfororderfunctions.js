				...
				submit : function(e, data) {
					var locale = window.mainController
						.getComponentByReferenceName(
							"orderMultiUploadLocale")
						.getValue().content.value;
					var orderId = window.mainController
						.getComponentByReferenceName(
							"orderIdForMultiUpload")
						.getValue();
					var orderIdValue = orderId.content;
					if(!orderIdValue.value || 0 === orderIdValue.value){
