...
<div id="orderTechnologicalProcessesAnalysisGrid" class="qcadoo-grid"></div>
<div id="pager" style="width:100%;height:20px;"></div>

<script src="/orders/public/js/orderTechnologicalProcessesAnalysis.js?ver=${buildNumber}"></script>
