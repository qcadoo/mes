...
<script src="/orders/public/js/multiuploadfororderfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/orders/multiUploadFilesForOrder.html" method="POST" enctype="multipart/form-data">
