    ...
    public void changedEnabledFieldForSpecificOrderState(final ViewDefinitionState view) {
        ...
        if (order.getStringField(STATE).equals(OrderState.IN_PROGRESS.getStringValue())) {
            List<String> references = Arrays.asList(DATE_FROM, DATE_TO, CORRECTED_DATE_TO, REASON_TYPES_CORRECTION_DATE_TO,
                    COMMENT_REASON_TYPE_CORRECTION_DATE_TO, EFFECTIVE_DATE_FROM, REASON_TYPES_DEVIATIONS_OF_EFFECTIVE_START,
                    COMMENT_REASON_TYPE_DEVIATIONS_OF_EFFECTIVE_START);
            changedEnabledFields(view, references, true);
        }
        ...
        if (order.getStringField(STATE).equals(OrderState.COMPLETED.getStringValue())) {
            List<String> references = Arrays.asList(EFFECTIVE_DATE_TO, COMMENT_REASON_TYPE_DEVIATIONS_OF_EFFECTIVE_END,
                    REASON_TYPES_DEVIATIONS_OF_EFFECTIVE_END);
            changedEnabledFields(view, references, true);
        }
    }
