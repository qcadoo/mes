...
public class OrderService {
    ...
    //
    // return ((parameterService.getParameter().getBooleanField(REASON_NEEDED_WHEN_DELAYED_EFFECTIVE_DATE_FROM) && (dateFromTime >
    // (effectiveDateFromTime + delayedEffectiveDateFromTime))) || (parameterService
    // .getParameter().getBooleanField(REASON_NEEDED_WHEN_EARLIER_EFFECTIVE_DATE_FROM) && (dateFromTime < (effectiveDateFromTime -
    // earlierEffectiveDateFromTime))));
    // }
    //
    ...
    //
    // return ((parameterService.getParameter().getBooleanField(REASON_NEEDED_WHEN_DELAYED_EFFECTIVE_DATE_TO) && (dateToTime >
    // (effectiveDateToTime + delayedEffectiveDateToTime))) || (parameterService
    // .getParameter().getBooleanField(REASON_NEEDED_WHEN_DELAYED_EFFECTIVE_DATE_TO) && (dateToTime < (effectiveDateToTime -
    // earlierEffectiveDateToTime))));
    // }
