package com.qcadoo.mes.orders.deviations.print;
...
import com.qcadoo.mes.orders.deviations.dataProvider.DeviationSummariesDataProvider;
import com.qcadoo.mes.orders.deviations.dataProvider.DeviationWithOccurrencesDataProvider;
import com.qcadoo.mes.orders.deviations.domain.DeviationSummary;
import com.qcadoo.mes.orders.deviations.domain.DeviationWithOccurrencesCount;
...
public class DeviationsProtocolPdf extends ReportPdfView {
    ...
    private static final ImmutableList<String> OCCURRENCES_TABLE_HEADERS = ImmutableList.of(
            "orders.deviations.report.deviationsShortSummary.table.header.no.label",
            "orders.deviations.report.deviationsShortSummary.table.header.deviationType.label",
            "orders.deviations.report.deviationsShortSummary.table.header.numberOfOccurrences.label");

    private static final ImmutableList<String> SUMMARIES_TABLE_HEADERS = ImmutableList.of(
            "orders.deviations.report.deviationDetailsByType.table.header.no.label",
            "orders.deviations.report.deviationDetailsByType.table.header.date.label",
            "orders.deviations.report.deviationDetailsByType.table.header.orderNumber.label",
            "orders.deviations.report.deviationDetailsByType.table.header.productNumber.label",
            "orders.deviations.report.deviationDetailsByType.table.header.comment.label");
    ...
    private PdfPTable createHeaderTable(final Interval searchDatesRange, final Locale locale) {
        ...
        pdfHelper.addTableCellAsTwoColumnsTable(headerTable, translate("orders.deviations.report.header.dateFrom.label", locale),
                DateUtils.toDateString(searchDatesRange.getStart().toDate()));
        pdfHelper.addTableCellAsTwoColumnsTable(headerTable, translate("orders.deviations.report.header.dateTo.label", locale),
    ...
    private VerticalLayout createShortSummarySection(final DeviationsReportCriteria criteria, final Locale locale) {
        ...
        Paragraph header = Headers.big(translate("orders.deviations.report.deviationsShortSummary.header", locale));
    ...
    private VerticalLayout createDetailedSummarySection(final DeviationsReportCriteria criteria, final Locale locale) {
        ...
        Paragraph header = Headers.big(translate("orders.deviations.report.deviationDetailsByType.header", locale));
    ...
    protected void addTitle(final Document document, final Locale locale) {
        document.addTitle("orders.deviations.report.title");
    }

    private void addDocumentTitle(Document document, Locale locale) throws DocumentException {
        String documentTitle = translationService.translate("orders.deviations.report.title", locale);
