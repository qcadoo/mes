 ...
 * ***************************************************************************
 */
package com.qcadoo.mes.productionBalancePerShift.factory;
...
import com.qcadoo.mes.productionBalancePerShift.constants.BalanceFields;
import com.qcadoo.mes.productionBalancePerShift.constants.ProductionBalancePerShiftConstants;
import com.qcadoo.mes.productionBalancePerShift.domain.ProductionProgressScope;
import com.qcadoo.mes.productionBalancePerShift.domain.QuantitiesBalance;
...
public class DefaultBalanceEntityFactory implements BalanceEntityFactory {
    ...
    private DataDefinition getDataDefinition() {
        return dataDefinitionService.get(ProductionBalancePerShiftConstants.PLUGIN_IDENTIFIER,
                ProductionBalancePerShiftConstants.MODEL_BALANCE);
    }
