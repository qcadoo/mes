...
public class ProductionRecordServiceImpl implements ProductionRecordService {
    ...
    public void fillShiftAndDivisionField(final ViewDefinitionState view) {
        LookupComponent staffLookup = (LookupComponent) view.getComponentByReference(ProductionRecordFields.STAFF);
        LookupComponent shiftLookup = (LookupComponent) view.getComponentByReference(ProductionRecordFields.SHIFT);
        LookupComponent divisionLookup = (LookupComponent) view.getComponentByReference(ProductionRecordFields.DIVISION);
        ...
        Entity shift = staff.getBelongsToField(ProductionRecordFields.SHIFT);
        ...
        Entity division = staff.getBelongsToField(ProductionRecordFields.DIVISION);
    ...
    public void fillDivisionField(final ViewDefinitionState view) {
        LookupComponent workstationTypeLookup = (LookupComponent) view
                .getComponentByReference(ProductionRecordFields.WORKSTATION_TYPE);
        LookupComponent divisionLookup = (LookupComponent) view.getComponentByReference(ProductionRecordFields.DIVISION);
        ...
        Entity division = workstationType.getBelongsToField(ProductionRecordFields.DIVISION);
