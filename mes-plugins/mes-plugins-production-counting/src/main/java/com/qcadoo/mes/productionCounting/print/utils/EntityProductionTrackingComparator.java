...
public class EntityProductionTrackingComparator implements Comparator<Entity>, Serializable {
    ...
    public final int compare(final Entity o1, final Entity o2) {
        return o1.getStringField(L_NUMBER).compareTo(o2.getStringField(L_NUMBER));
    }
