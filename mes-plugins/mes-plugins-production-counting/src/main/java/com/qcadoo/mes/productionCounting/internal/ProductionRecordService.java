...
public class ProductionRecordService {
    ...
    private void setComponentVisible(final boolean forEach, final boolean cumulated, final boolean none,
        ...
        viewDefinitionState.getComponentByReference("orderOperationComponent").setVisible(none ? forEach : cumulated);
        ((FieldComponent) viewDefinitionState.getComponentByReference("orderOperationComponent")).requestComponentUpdateState();
        viewDefinitionState.getComponentByReference("borderLayoutConsumedTimeForEach").setVisible(forEach);
        viewDefinitionState.getComponentByReference("borderLayoutConsumedTimeCumulated").setVisible(cumulated);
        viewDefinitionState.getComponentByReference("operationNoneLabel").setVisible(none);
    }
