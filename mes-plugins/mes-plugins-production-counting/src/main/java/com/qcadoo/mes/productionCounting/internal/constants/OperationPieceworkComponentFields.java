...
public final class OperationPieceworkComponentFields {

    private OperationPieceworkComponentFields() {
    ...
    public static final String PLANNED_CYCLES = "plannedCycles";

    public static final String CYCLES = "cycles";

    public static final String CYCLES_BALANCE = "cyclesBalance";
