...
public final class ProductionAnalysisDtoFields {

    private ProductionAnalysisDtoFields() {
    ...
    public static final String ASSORTMENT_ID = "assortment_id";
    ...
    public static final String OBTAINED_MASTER_ORDER_NUMBER = "obtainedMasterOrderNumber";
