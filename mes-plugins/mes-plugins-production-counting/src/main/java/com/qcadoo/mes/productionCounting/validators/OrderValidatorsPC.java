...
public class OrderValidatorsPC {
    ...
    public boolean checkAutoCloseFlagForSynchronizedOrder(final DataDefinition orderDD, final Entity order) {
        Entity parameter = parameterService.getParameter();

        if (parameter.getBooleanField(ParameterFieldsPC.AUTO_CLOSE_ORDER)
