...
<div id="employeePieceworkSettlementGrid" class="qcadoo-grid"></div>
<div id="pager" style="width:100%;height:20px;"></div>

<script src="/productionCounting/public/js/employeePieceworkSettlement.js?ver=${buildNumber}"></script>
