...
QCD.employeeWorkingTimeSettlement = (function() {
    ...
    function init() {
        ...
        $.get("/rest/emplWorkingTimeSettlement/validate", params, function(message) {
            if (message) {
                ...
                $.get("/rest/emplWorkingTimeSettlement/columns", function(columns) {
                    $('#employeeWorkingTimeSettlementGrid').height($('#window_windowContent').height() - 80);
                    $('#employeeWorkingTimeSettlementGrid').width($('#window_windowContent').width() - 20);
                    ...
                    grid = new Slick.Grid("#employeeWorkingTimeSettlementGrid", dataView, columns, options);
                    ...
                    $.get("/rest/emplWorkingTimeSettlement/records", params, function(records) {
                        grid.init();
    ...
    function exportToCsv() {
        ...
        $.ajax({
            url: "/rest/emplWorkingTimeSettlement/exportToCsv",
            type: 'POST',
            dataType: 'json',
