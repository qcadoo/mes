...
public class TestSamplesLoader extends SamplesLoader {
    ...
    void addProductionRecord(final Map<String, String> values) {
        ...
        recOpProdInComponents.add(addRecordOperationProductInComponent(getProductByNumber("000019"), new BigDecimal(
                QUANTITY_600_L), new BigDecimal(QUANTITY_600_L), new BigDecimal("0")));
        recOpProdInComponents.add(addRecordOperationProductInComponent(getProductByNumber("000020"), new BigDecimal(
                QUANTITY_2400_L), new BigDecimal(QUANTITY_2400_L), new BigDecimal("0")));
        ...
        List<Entity> recOpProdOutComponents1 = Lists
                .newArrayList(addRecordOperationProductOutComponent(getProductByNumber("000017"), new BigDecimal(QUANTITY_150_L),
                        new BigDecimal(QUANTITY_150_L), new BigDecimal("0")));
