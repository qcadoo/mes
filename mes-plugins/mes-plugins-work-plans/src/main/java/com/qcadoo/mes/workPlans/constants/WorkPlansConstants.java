...
public interface WorkPlansConstants {
    ...
    public static final String MODEL_WORK_PLAN_COMPONENT = "workPlanComponent";

    // VIEW
    public static final String VIEW_WORK_PLAN_COMPONENT_DETAILS = "workPlanComponentDetails";
