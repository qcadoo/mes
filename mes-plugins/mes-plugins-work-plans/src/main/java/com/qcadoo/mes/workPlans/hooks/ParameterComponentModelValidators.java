...
public class ParameterComponentModelValidators {
    ...
    public final boolean checkIfColumnForInputProductsIsNotAlreadyUsed(final DataDefinition inputComponentDD,
        ...
        Entity parameter = inputComponent.getBelongsToField("parameter");

        EntityList parameterInputComponents = parameter.getHasManyField("parameterInputComponents");
    ...
    public final boolean checkIfColumnForOutputProductsIsNotAlreadyUsed(final DataDefinition outputComponentDD,
        ...
        Entity parameter = outputComponent.getBelongsToField("parameter");

        EntityList parameterOutputComponents = parameter.getHasManyField("parameterOutputComponents");
