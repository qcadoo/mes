...
public class OrderOperationComponentModelValidators {
    ...
    public final boolean checkIfColumnForInputProductsIsNotAlreadyUsed(final DataDefinition inputComponentDD,
        ...
        Entity parameter = inputComponent.getBelongsToField("orderOperationComponent");

        EntityList parameterInputComponents = parameter.getHasManyField("orderOperationInputComponents");
    ...
    public final boolean checkIfColumnForOutputProductsIsNotAlreadyUsed(final DataDefinition outputComponentDD,
        ...
        Entity parameter = outputComponent.getBelongsToField("orderOperationComponent");

        EntityList parameterOutputComponents = parameter.getHasManyField("orderOperationOutputComponents");
