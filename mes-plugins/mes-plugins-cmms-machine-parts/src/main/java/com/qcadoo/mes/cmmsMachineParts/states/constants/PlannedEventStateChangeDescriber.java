...
@Service
public final class PlannedEventStateChangeDescriber extends AbstractStateChangeDescriber {
    ...
    public DataDefinition getDataDefinition() {
        return dataDefinitionService.get(CmmsMachinePartsConstants.PLUGIN_IDENTIFIER,
                CmmsMachinePartsConstants.MODEL_PLANNED_EVENT_STATE_CHANGE);
    }

    @Override
    public String getOwnerFieldName() {
        return PlannedEventStateChangeFields.PLANNED_EVENT;
    }

    @Override
    public StateEnum parseStateEnum(final String stringValue) {
        return PlannedEventState.parseString(stringValue);
    }
