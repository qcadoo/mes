...
@Aspect
@Service
public class MaintenanceEventStateChangeAspect extends AbstractStateChangeAspect {

    @Autowired
    private MaintenanceEventStateChangeDescriber maintenanceEventStateChangeDescriber;

    public static final String SELECTOR_POINTCUT = "this(com.qcadoo.mes.cmmsMachineParts.states.aop.MaintenanceEventStateChangeAspect)";

    @Override
    public StateChangeEntityDescriber getChangeEntityDescriber() {
        return maintenanceEventStateChangeDescriber;
    }
    ...
    protected int getNumOfPhases() {
        return MaintenanceEventStateChangePhase.getNumOfPhases();
    }
