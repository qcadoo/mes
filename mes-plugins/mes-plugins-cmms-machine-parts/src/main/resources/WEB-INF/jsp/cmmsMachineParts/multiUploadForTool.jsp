...
<script src="/cmmsMachineParts/public/js/multiuploadfortoolfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/cmmsMachineParts/multiUploadFilesForTool.html" method="POST" enctype="multipart/form-data">
