			...
			.fileupload(
					{
						...
						dataType : 'json',
						acceptFileTypes : /(\.|\/)(gif|jpe?g|png|pdf|xls|xlsx|dwg|ipt|iam|idw)$/i,
						...
						submit : function(e, data) {
							...
							.getComponentByReferenceName(
								"eventMultiUploadLocale")
									.getValue().content.value;
							var filetype = /(\.|\/)(gif|jpe?g|png|pdf|dwg|ipt|iam|idw)$/i;
					...
					'fileuploadadd',
					function(e, data) {
						var filetype = /(\.|\/)(gif|jpe?g|png|pdf|xls|xlsx|dwg|ipt|iam|idw)$/i;
						var locale = window.mainController
						.getComponentByReferenceName(
							"eventMultiUploadLocale")
								.getValue().content.value;
