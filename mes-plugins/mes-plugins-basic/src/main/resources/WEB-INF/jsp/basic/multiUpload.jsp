...
<script src="/basic/public/js/multiuploadfunctions.js"></script>
...
<form id="fileupload" action="../../../rest/basic/multiUploadFiles.html" method="POST" enctype="multipart/form-data">
