                           ...
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label required" for="product"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.product']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.product']}</label>
                                 </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label required " for="quantity"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.quantity']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.quantity']}</label>
                                 </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label" for="description"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.description']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.description']}</label>
                                 </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label" for="technology"  data-toggle="tooltip" autocomplete="off" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.technology']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.technology']}</label>
                                 </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label required" for="productionLine"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.productionLine']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.productionLine']}</label>
                                 </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label required " for="startDate"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.startDate']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.startDate']}</label>
                                 </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-sm-8">
                              <div class="input-group">
                                 <div class="input-group-prepend">
                                    <label class="form-label required " for="finishDate"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.finishDate']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.finishDate']}</label>
                                 </div>
                        ...
                        <table id="materials" data-search="false" data-toolbar="#materials-toolbar">
                           <thead>
                              <tr>
                                 ...
                                 <th data-field="quantityPerUnit" data-formatter="quantityPerUnitFormatter" data-switchable="false" data-sortable="false" data-align="center">${translationsMap['basic.dashboard.orderDefinitionWizard.materials.quantityPerUnit']}</th>
                     ...
                     <div class="prev">
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label required" for="prev_product"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.product']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.product']}</label>
                                    </div>
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label required " for="prev_quantity"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.quantity']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.quantity']}</label>
                                    </div>
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label" for="prev_description"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.description']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.description']}</label>
                                    </div>
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label" for="prev_technology"  data-toggle="tooltip" autocomplete="off" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.technology']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.technology']}</label>
                                    </div>
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label required" for="prev_productionLine"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.productionLine']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.productionLine']}</label>
                                    </div>
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label required " for="prev_startDate"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.startDate']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.startDate']}</label>
                                    </div>
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col-sm-8">
                                 <div class="input-group">
                                    <div class="input-group-prepend">
                                       <label class="form-label required " for="prev_finishDate"  data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.finishDate']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.finishDate']}</label>
                                    </div>
                        ...
                        <div class="form-group" style="width: 100%;">
                           <div id="prev_materials-toolbar">
                              <label class="form-label required " data-toggle="tooltip" title=${translationsMap['basic.dashboard.orderDefinitionWizard.form.materials']}>${translationsMap['basic.dashboard.orderDefinitionWizard.form.materials']}</label>
                           </div>
