...
public class PalletNumberHelperReportPdf extends ReportPdfView {
    ...
    protected String addContent(final Document document, final Map<String, Object> model, final Locale locale,
        ...
        addNumber(document, number);

        return translationService.translate("basic.palletNumber.report.fileName", locale, number);
    }

    private void addNumber(final Document document, final String number) throws DocumentException {
        ...
        firstNumberParagraph.setSpacingBefore(50F);
