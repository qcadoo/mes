...
@Aspect
@Service
public class NegotiationStateChangeAspect extends AbstractStateChangeAspect {

    @Autowired
    private NegotiationStateChangeDescriber negotiationStateChangeDescriber;

    public static final String SELECTOR_POINTCUT = "this(com.qcadoo.mes.supplyNegotiations.states.aop.NegotiationStateChangeAspect)";

    @Override
    public StateChangeEntityDescriber getChangeEntityDescriber() {
        return negotiationStateChangeDescriber;
    }
    ...
    protected int getNumOfPhases() {
        return NegotiationStateChangePhase.getNumOfPhases();
    }
