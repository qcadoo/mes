...
@Service
public class RequestForQuotationValidationService {
    ...
    public void validationOnAccepted(final StateChangeContext stateChangeContext) {
        ...
        if (stateChangeEntity.getField(DESIRED_DATE) == null) {
            stateChangeContext.addFieldValidationError(DESIRED_DATE,
                    "supplyNegotiations.requestForQuotation.desiredDate.fieldRequired");
        }
    }
