...
public class MaterialFlowServiceTest {
    ...
    public void shouldCalculateShouldBeForOnlyTransfers() {
        ...
        assertEquals(new BigDecimal(1500), materialFlowService.calculateShouldBeInStockArea(stockAreas, product, forDate));
    }
    ...
    public void shouldCalculateShouldBeForOnlyStockCorrections() {
        ...
        assertEquals(new BigDecimal(1000), materialFlowService.calculateShouldBeInStockArea(stockAreas, product, forDate));
    }
