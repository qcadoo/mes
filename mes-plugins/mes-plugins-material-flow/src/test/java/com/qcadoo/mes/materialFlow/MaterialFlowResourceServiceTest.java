...
public class MaterialFlowResourceServiceTest {
    ...
    @Mock
    private Entity resource, resource1, resource2, stockAreas, product, transfer, stockAreasFrom, stockAreasTo;
    ...
    public void init() {
        ...
        materialFlowResourceService = new MaterialFlowResourceServiceImpl();
    ...
    public void shouldReturnFalseWhenAreResourcesSufficientIfResourcesAreNull() {
        // given
        given(dataDefinitionService.get(MaterialFlowConstants.PLUGIN_IDENTIFIER, MaterialFlowConstants.MODEL_RESOURCE))
                .willReturn(resourceDD);
        ...
        // when
        boolean result = materialFlowResourceService.areResourcesSufficient(stockAreas, product, quantity);
    ...
    public void shouldAddResoruceWhenManageResourcesAndTranserIsntNullAndTypeIsProduction() {
        ...
        given(transfer.getBelongsToField(STOCK_AREAS_FROM)).willReturn(stockAreasFrom);
        given(transfer.getBelongsToField(STOCK_AREAS_TO)).willReturn(stockAreasTo);
