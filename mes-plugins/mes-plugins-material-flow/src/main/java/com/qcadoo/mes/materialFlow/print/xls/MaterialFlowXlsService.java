...
public final class MaterialFlowXlsService extends XlsDocumentService {
    ...
    protected void addHeader(final HSSFSheet sheet, final Locale locale) {
        ...
        cell0.setCellValue(getTranslationService().translate("materialFlow.materialFlow.report.columnHeader.number", locale));
        cell0.setCellStyle(XlsUtil.getHeaderStyle(sheet.getWorkbook()));
        HSSFCell cell1 = header.createCell(1);
        cell1.setCellValue(getTranslationService().translate("materialFlow.materialFlow.report.columnHeader.name", locale));
        cell1.setCellStyle(XlsUtil.getHeaderStyle(sheet.getWorkbook()));
        HSSFCell cell2 = header.createCell(2);
        cell2.setCellValue(getTranslationService().translate("materialFlow.materialFlow.report.columnHeader.quantity", locale));
        cell2.setCellStyle(XlsUtil.getHeaderStyle(sheet.getWorkbook()));
        HSSFCell cell3 = header.createCell(3);
        cell3.setCellValue(getTranslationService().translate("materialFlow.materialFlow.report.columnHeader.unit", locale));
