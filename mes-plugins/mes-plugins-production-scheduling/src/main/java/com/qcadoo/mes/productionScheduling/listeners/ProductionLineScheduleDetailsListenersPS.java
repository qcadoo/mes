...
@Service
public class ProductionLineScheduleDetailsListenersPS {
    ...
    private void assignOrdersToProductionLines(Entity schedule, List<Entity> productionLines) {
        ...
        for (Long positionId : positionsIds) {
            ...
            boolean allProductionLineWorkTimesIsTooLong = getProductionLinesNewFinishDate(productionLinesFinishDates, scheduleStartTime,
                    position, orderProductionLines, orderProductionLinesPositionNewData, durationOfOrderCalculatedOnBasis);

            if (allProductionLineWorkTimesIsTooLong) {
                continue;
            }
    ...
    private boolean getProductionLinesNewFinishDate(Map<Long, Date> productionLinesFinishDates, Date scheduleStartTime,
        ...
        boolean allProductionLineWorkTimesIsTooLong = true;
        for (Entity productionLine : orderProductionLines) {
            ...
            if (DurationOfOrderCalculatedOnBasis.TIME_CONSUMING_TECHNOLOGY.getStringValue()
                ...
                if (maxPathTime > OrderRealizationTimeService.MAX_REALIZATION_TIME || maxPathTime == 0) {
                    ...
                    allProductionLineWorkTimesIsTooLong = false;
                }
        ...
        return allProductionLineWorkTimesIsTooLong;
    }
