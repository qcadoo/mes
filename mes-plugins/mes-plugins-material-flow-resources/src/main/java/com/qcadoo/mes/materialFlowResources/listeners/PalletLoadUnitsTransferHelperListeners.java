...
import com.qcadoo.mes.materialFlowResources.service.LoadUnitsTransferService;
...
public class PalletLoadUnitsTransferHelperListeners {
    ...
    @Autowired
    private LoadUnitsTransferService loadUnitsTransferService;
    ...
    private boolean tryCreatePositions(Entity document, ViewDefinitionState view, List<Entity> resources) {
        ...
        for (Entity resource : resources) {
            try {
                Entity newPosition = loadUnitsTransferService.createPosition(document, resource);
