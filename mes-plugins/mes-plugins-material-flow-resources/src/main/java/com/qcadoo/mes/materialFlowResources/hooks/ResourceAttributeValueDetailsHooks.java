...
@Service
public class ResourceAttributeValueDetailsHooks {
    ...
    public void onBeforeRender(final ViewDefinitionState view) {
        ...
        LookupComponent attributeValueLookup = (LookupComponent) view
                .getComponentByReference(ResourceAttributeValueFields.ATTRIBUTE_VALUE);
    ...
    private void fillFromDefinition(final ViewDefinitionState view) {
        CheckBoxComponent fromDefinition = (CheckBoxComponent) view
                .getComponentByReference(ResourceAttributeValueFields.FROM_DEFINITION);
