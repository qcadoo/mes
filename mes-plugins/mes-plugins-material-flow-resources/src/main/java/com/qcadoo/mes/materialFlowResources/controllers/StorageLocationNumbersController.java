...
public class StorageLocationNumbersController {

    @RequestMapping(value = "storageLocationNumberHelperReport.pdf")
    public final ModelAndView palletNumberHelperReportPdf(@RequestParam("id") final String id) {
        ModelAndView mav = new ModelAndView();

        mav.setViewName("storageLocationNumberHelperReportPdf");
        mav.addObject("id", id);
