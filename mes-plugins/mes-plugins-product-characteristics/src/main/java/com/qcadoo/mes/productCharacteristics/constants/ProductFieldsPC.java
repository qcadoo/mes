...
public final class ProductFieldsPC {

    private ProductFieldsPC() {
    ...
    public static final String UP_SHELVE = "upShelve";

    public static final String DOWN_SHELVE = "downShelve";
