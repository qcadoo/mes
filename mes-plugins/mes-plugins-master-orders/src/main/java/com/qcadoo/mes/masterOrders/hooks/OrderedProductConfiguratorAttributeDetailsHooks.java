...
public class OrderedProductConfiguratorAttributeDetailsHooks {
    ...
    public void setCriteriaModifierParameters(final ViewDefinitionState view) {
        ...
        List<Long> attributes = getAttributes(orderedProductConfiguratorAttributes);
        ...
        if (attributes.isEmpty()) {
            ...
            filterValueHolder.put(OrderedProductConfiguratorCriteriaModifiers.ATTRIBUTE_IDS, attributes);
        }

        attributesGrid.setFilterValue(filterValueHolder);
    }

    private List<Long> getAttributes(final List<Entity> orderedProductConfiguratorAttributes) {
