...
public class OperationalTasksListHooksOTTest {
    ...
    public void init() {
        ...
        operationalTasksListHooks = new OperationalTasksListHooks();

        PowerMockito.mockStatic(SearchRestrictions.class);

        ReflectionTestUtils.setField(operationalTasksListHooks, "dataDefinitionService", dataDefinitionService);
