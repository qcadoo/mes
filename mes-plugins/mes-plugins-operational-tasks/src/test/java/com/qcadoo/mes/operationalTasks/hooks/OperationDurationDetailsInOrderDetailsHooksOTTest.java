...
public class OperationDurationDetailsInOrderDetailsHooksOTTest {
    ...
    private OperationDurationDetailsInOrderDetailsHooks operationDurationDetailsInOrderDetailsHooksOTFO;
    ...
    public void init() {
        ...
        operationDurationDetailsInOrderDetailsHooksOTFO = new OperationDurationDetailsInOrderDetailsHooks();
