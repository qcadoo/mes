...
/**
 * Field defines database field or custom field (according to
 * {@link FieldDefinition#isCustomField()}).
 * 
...
public final class FieldDefinition {
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(13, 31).append(customField)
				.append(defaultValue).append(editable).append(hidden)
				.append(name).append(required).append(type).append(unique)
				.append(validators).toHashCode();
	}
	...
	public boolean equals(final Object obj) {
		...
		return new EqualsBuilder().append(customField, other.customField)
				.append(defaultValue, other.defaultValue)
				.append(editable, other.editable).append(hidden, other.hidden)
				.append(name, other.name).append(required, other.required)
				.append(type, other.type).append(unique, other.unique)
