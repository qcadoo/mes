 ...
 */
public final class GridDefinition extends ComponentDefinitionImpl<ListData> {
    ...
    public GridDefinition(final String name, final ContainerComponent<?> parentContainer, final String fieldPath,
