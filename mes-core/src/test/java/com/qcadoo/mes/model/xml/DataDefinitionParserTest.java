...
public class DataDefinitionParserTest {
    ...
    public void shouldSetFields() {
        ...
        assertEquals("child2", ((TreeType) (dataDefinition.getField("children2")).getType()).getJoinFieldName());
        ...
        assertEquals(TreeType.Cascade.DELETE, getField(dataDefinition.getField("children2").getType(), "cascade"));
        assertThat(dataDefinition.getField("children2").getType(), instanceOf(TreeEntitiesType.class));
        ...
        assertThat(((EnumType) dataDefinition.getField("typeOfMaterial").getType()).values(),
                JUnitMatchers.hasItems("03product", "02intermediate", "01component", "04waste"));
