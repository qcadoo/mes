...
package com.qcadoo.mes.viewold.components.grid;
 ...
 * 
 * Method {@link com.qcadoo.mes.viewold.components.grid.ColumnDefinition#getValue(Entity, Locale)} returns value of the column for
 * given entity.
 * 
