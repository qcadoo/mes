...
public class SelectComponentPattern extends AbstractComponentPattern {
    ...
    public SelectComponentPattern(final String name, final String fieldPath, final String sourceFieldPath,
