...
@ViewComponent("tree")
public class TreeComponentPattern extends AbstractComponentPattern {
    ...
    public TreeComponentPattern(final String name, final String fieldPath, final String sourceFieldPath,
