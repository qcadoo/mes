...
--
-- Name: fk1de839de147174cf; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY basic_product
    ADD CONSTRAINT fk1de839de147174cf FOREIGN KEY (companyproductfamily_id) REFERENCES basic_company(id);


--
-- Name: fk1de839de1a082533; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY basic_product
    ADD CONSTRAINT fk1de839de1a082533 FOREIGN KEY (companyproduct_id) REFERENCES basic_company(id);
